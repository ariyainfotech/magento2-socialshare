# Mage2 Module AriyaInfoTech SocialShare

    ``ariyainfotech/module-socialshare``
...
### Type 1: Zip file
 ...
 - Enable the module by running `php bin/magento module:enable AriyaInfoTech_SocialShare`
